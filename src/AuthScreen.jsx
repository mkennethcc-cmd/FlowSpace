...
export default function AuthScreen() {
  ...
  return (
    <div style={{ height: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#0c0e16", fontFamily: "'DM Sans',sans-serif" }}>
      ...
      <div style={{ width: 360, padding: 32, background: "#141828", borderRadius: 20, border: "1px solid rgba(255,255,255,.07)", boxShadow: "0 24px 60px rgba(0,0,0,.5)" }}>
        ...
        <div style={{ textAlign: "center", margin: "16px 0", color: "#7a85a3", fontSize: 12 }}>or</div>
        <button onClick={googleLogin} style={{ width: "100%", padding: 11, borderRadius: 10, border: "1px solid rgba(255,255,255,.1)", cursor: "pointer", background: "transparent", color: "#eef0fa", fontWeight: 600, fontSize: 14, fontFamily: "'DM Sans',sans-serif", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, boxSizing: "border-box" }}>
